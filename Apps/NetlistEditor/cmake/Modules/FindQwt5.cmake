...
IF( QT4_FOUND )
  ...
  FIND_PATH( Qwt5_INCLUDE_DIR qwt.h 
               ...
               PATH_SUFFIXES qwt qwt5 qwt-qt4 qwt5-qt4 qwt-qt3 qwt5-qt3 include qwt/include qwt5/include qwt-qt4/include qwt5-qt4/include qwt-qt3/include qwt5-qt3/include
               ENV PATH)
  ...
  IF( Qwt5_INCLUDE_DIR )
    ...
    FIND_LIBRARY( Qwt5_Qt4_TENTATIVE_LIBRARY
               NAMES qwt5-qt4 qwt-qt4 qwt5 qwt
               PATHS /usr/local/qwt/lib /usr/local/lib /usr/lib "${QT_LIBRARY_DIR}" "${Qwt5_INCLUDE_DIR}/.."
    ...
    #   IF( APPLE )
    #     EXECUTE_PROCESS( COMMAND "otool" "-L" ${Qwt5_Qt3_TENTATIVE_LIBRARY} OUTPUT_VARIABLE Qwt5_Qt3_LIBRARIES_LINKED_TO )
    #   ELSE( APPLE )
    #     EXECUTE_PROCESS( COMMAND "ldd" ${Qwt5_Qt3_TENTATIVE_LIBRARY} OUTPUT_VARIABLE Qwt5_Qt3_LIBRARIES_LINKED_TO )
    #   ENDIF( APPLE )
    #   STRING( REGEX MATCH "qt-mt" Qwt5_IS_LINKED_TO_Qt3 ${Qwt5_Qt3_LIBRARIES_LINKED_TO})
