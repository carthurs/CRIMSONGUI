/*!
* \file    BRepFill_SectionPlacement_A.cxx
*
* \brief   This file is a full copy of BRepFill_SectionPlacement.cxx from OpenCASCADE, but with support for 'subCurveLaws'
*/
...
BRepFill_SectionPlacement_A::
BRepFill_SectionPlacement_A(const Handle(BRepFill_LocationLaw)& Law,
			  ...
			  myLaw(Law), mySection(Section)
{
 ...
 void BRepFill_SectionPlacement_A::Perform(const Standard_Boolean WithContact,
					 const Standard_Boolean WithCorrection,
					 const TopoDS_Shape& Vertex) 
{
  TopoDS_Vertex TheV; 
...
//   }
 ...
 const gp_Trsf& BRepFill_SectionPlacement_A::Transformation() const
{
  return myTrsf;
}

 Standard_Real BRepFill_SectionPlacement_A::AbscissaOnPath()
{
