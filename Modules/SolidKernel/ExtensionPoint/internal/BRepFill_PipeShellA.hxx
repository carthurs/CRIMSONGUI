...
#ifndef _BRepFill_PipeShellA_HeaderFile
#define _BRepFill_PipeShellA_HeaderFile
...
public:
  ...
  //! along the path.
  Standard_EXPORT   void Set(const TopoDS_Wire& AuxiliarySpine, const std::vector<Handle(GeomFill_GuideTrihedronAC_A)>& subCurveLaws, const Standard_Boolean CurvilinearEquivalence = Standard_True, const BRepFill_TypeOfContact KeepContact = BRepFill_NoContact);
  ...
  DEFINE_STANDARD_RTTI(BRepFill_PipeShell)
      ...
      Handle(GeomFill_GuideTrihedronAC_A) myTrihedronLaw;

      Standard_EXPORT   Standard_Real Place(const BRepFill_Section& Sec, TopoDS_Wire& W, gp_Trsf& Trsf, Standard_Real& param);
...
#endif // _BRepFill_PipeShellA_HeaderFile
