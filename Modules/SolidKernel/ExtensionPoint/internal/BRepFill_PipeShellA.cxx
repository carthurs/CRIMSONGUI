/*!
 * \file    BRepFill_PipeShellA.cxx
 *
 * \brief   This file is a full copy of BRepFill_PipeShell.cxx from OpenCASCADE, but with support for 'subCurveLaws'.
 */
...
#include <internal/BRepFill_SectionPlacement_A.hxx>
...
//=======================================================================
 void BRepFill_PipeShell::Set(const TopoDS_Wire& AuxiliarySpine,
     const std::vector<Handle(GeomFill_GuideTrihedronAC_A)>& subCurveLaws,
...
{  
  ...
  if (CurvilinearEquivalence) { // trihedron by curvilinear reduced abscissa
    ...
    myTrihedronLaw
      = new (GeomFill_GuideTrihedronAC_A) (Guide);
    myTrihedronLaw->setSubCurveLaws(subCurveLaws);            
    Handle(GeomFill_LocationGuide) Loc = 
        new (GeomFill_LocationGuide)(myTrihedronLaw);
...
//purpose  : 
//=======================================================================
//  void BRepFill_PipeShellA::Generated(const TopoDS_Shape& ,
...
//       mySection = new (BRepFill_NSections) (WSeq,Transformations,Param,V1,V2);    
...
//=======================================================================
Standard_Real BRepFill_PipeShell::Place(const BRepFill_Section& Sec,
			       TopoDS_Wire& W,
                               gp_Trsf& aTrsf,
			       Standard_Real& param)
{
  BRepFill_SectionPlacement_A Place(myLocation, 
				  Sec.Wire(),
				  Sec.Vertex(),
				  Sec.WithContact(),
				  Sec.WithCorrection());
