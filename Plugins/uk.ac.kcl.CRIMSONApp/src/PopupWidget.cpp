...
void PopupWidgetPrivate::init()
{
    ...
    this->PopupPixmapWidget->setObjectName("PopupPixmapWidget");
    ...
    this->FramePage->setObjectName("PopupWidgetFramePage");
    auto verticalLayout = new QVBoxLayout(this->FramePage);
    verticalLayout->setContentsMargins(0, 0, 0, 0);
    this->Frame = new QFrame(FramePage);
    this->Frame->setObjectName("PopupWidgetFrame");
    verticalLayout->addWidget(this->Frame);

    q->addWidget(FramePage);

    this->PopupPixmapWidgetPage = new QWidget();
    this->PopupPixmapWidgetPage->setObjectName("PopupPixmapWidgetPage");
