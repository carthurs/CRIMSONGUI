...
public:
	...
	static void setContourVisibility(mitk::DataNode* contourNode, bool show, mitk::RenderingManager* manager);
	static void setAllVesselContoursVisibility(mitk::DataNode* vesselPathNode, bool show, mitk::RenderingManager* manager);
