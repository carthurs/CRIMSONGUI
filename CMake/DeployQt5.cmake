...
#=============================================================================
# Qt5 version modified by Rostislav Khlebnikov <rostislav.khlebnikov@kcl.ac.uk>
#=============================================================================
...
function(install_qt5_plugin plugin executable copy installed_plugin_path_var)
  ...
  if(EXISTS "${plugin}")
    ...
    get_property(loc TARGET ${plugin} PROPERTY LOCATION_RELEASE)
    install_qt5_plugin_path("${loc}" "${executable}" "${copy}" "${installed_plugin_path_var}" "${plugins_dir}" "${component}")
  endif()
